...
<table width=100%>
<tr align=right>
<td width=2400px><b>НДС</b></td><td width=800px><b><?php echo f_d($itogo->itogo_nds); ?></b></td>
</tr>
<tr align=right>
<td width=2400px><b>Начислено</b></td><td width=800px><b><?php echo f_d($itogo->itogo_with_nds); ?></b></td>
</tr>
<tr align=right>
...
<br><br>
    ...
    <?php if (($is_fine)and($period_id >= 116)): ?>
        ...
        <tr><td align="center"><b>ВНИМАНИЕ: ОПЛАТУ ПЕНИ ПРОИЗВОДИТЬ ОТДЕЛЬНО!</b></td></tr>
    </table>
    <?php endif; ?>
    <!--end of fine-->
