...
<html>
	...
	<tr><td>
		...
		<tr><td>
 	<p><o:p> </o:p>
		<table border="1" cellspacing="0" cellpadding="0" align="right" width="1050px">
			<tr>
		...
		<table border=1 cellspacing=0 cellpadding=0 width="1050px" >
			<tr>
...
?>	
	...
	?></td>
		...
		<p><o:p> </o:p></p>
		<p>Всего отпущено запасов (количество прописью): <?php echo kvt2str($i_kvt);?></p>
		<p><o:p> </o:p></p>
		<p>Всего отпущено на сумму (прописью), в KZT: <?php echo num2str($itog->itogo_with_nds);?></p>
		<p><o:p> </o:p> </p>
