...
if ($saldo > 0) {
    ...
    if ($firm_veds->is_budget == 1) {
        $what_month = 'прошлый';
        $pinfo = $prev_period_info->name;
    } else {
        $what_month = 'текущий';
        $pinfo = $period_info->name;
    }
    echo ". Начислено за $what_month месяц: <b>" . prettify_number($dolg_new) . "</b><br>";
    ?>
    <table class="border-table" border="1px">
        ...
        <tr class="head-tr">
            ...
            <th>Начисление <br>за <?php echo $pinfo; ?>, тнг</th>
            <th>Ставка<br>реф.(%)</th>
            <th>Коэф.</th>
            <th>Сумма оплаты, тнг</th>
            <th>Пеня по долгу <br>за один день, тнг</th>
            <th>Итого пени <br>по долгу, тнг</th>
            <th>Пеня по начислению <br>за <?php echo $pinfo; ?> <br>за один день, тнг</th>
            <th>Итого пени по начислению <br>за <?php echo $pinfo; ?>, тнг</th>
